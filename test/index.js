...
function main (binding) {
  const { Runtime, Context, std, detectModule } = binding
  console.log(binding)
  ...
  const byteCode = ctx.compile('console.log("hello qjs")')
  console.log(byteCode)
  std.evalBinary(ctx, byteCode)
  ...
  console.log(detectModule('import {}'))
  console.log(detectModule('var a = 1'))
}
